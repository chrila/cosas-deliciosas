...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post beers_url, params: { beer: { abv: @beer.abv, beer_style_id: @beer.beer_style_id, brewery_id: @beer.brewery_id, ibu: @beer.ibu } }
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { abv: @beer.abv, beer_style_id: @beer.beer_style_id, brewery_id: @beer.brewery_id, ibu: @beer.ibu } }
