...
class TastingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tasting" do
    assert_difference('Tasting.count') do
      post tastings_url, params: { tasting: { beer_id: @tasting.beer_id, comment: @tasting.comment, place: @tasting.place, price: @tasting.price, rating: @tasting.rating, serving_format_id: @tasting.serving_format_id } }
    end
  ...
  test "should update tasting" do
    patch tasting_url(@tasting), params: { tasting: { beer_id: @tasting.beer_id, comment: @tasting.comment, place: @tasting.place, price: @tasting.price, rating: @tasting.rating, serving_format_id: @tasting.serving_format_id } }
